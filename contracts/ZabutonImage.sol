...
contract ZabutonImage is IZabutonImage {
    function getImage(uint256 num) public pure returns (string memory) {
        ...
        string
            memory frame2 = '<pattern id="c" width="72" height="72" y="1080"  patternUnits="userSpaceOnUse" viewBox="72.2 -72 72 72"><g fill="none"><path d="M72-72h72V0H72z"/><path d="M72-72h72V0H72z"/><path stroke="#40FF5C" stroke-width="6" d="M144-66h73m-73 24h73m-73 24h73m-73-36h73m-73 24h73M144-6h73M72-66h73M72-42h73M72-18h73M72-54h73M72-30h73M72-6h73M0-66h73M0-42h73M0-18h73M0-54h73M0-30h73M0-6h73"/></g></pattern><path fill="none" stroke="#40FF5C" stroke-miterlimit="10" stroke-width="3.5" d="M28 1054h1024v-24"/><pattern xlink:href="#c" id="d" patternTransform="matrix(1 1 1 -1 -2940 -12099)"/><path fill="url(#d)" d="M29 896h67v140H29z"/><path fill="url(#d)" d="M29 740h67v140H29z"/>';
        string
