...
contract ZabutonImage is IZabutonImage {
    function getImage(uint256 num) public pure returns (string memory) {
        ...
        string
            memory frame3 = '<path fill="none" stroke="#40FF5C" stroke-miterlimit="10" stroke-width="3.5" d="M28 1054h1024v-24 M28 28v88h300l33-30V28z M490 540h100m-50 50V490 M40 540h100m800 0h100M540 1040V940m0-800V40"/>';
